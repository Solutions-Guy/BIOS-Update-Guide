For multi-node systems, such as Supermicro BigTwin SuperServer, manually updating the BIOS of all nodes can take a considerable amount of time. Redfish APIs can help automate and streamline the BIOS update process.

This repository provides instructions on how to update the BIOS with a compatible image through Redfish methods on X11 BigTwin systems. This method is compatible with BMC version 1.71.xx.
